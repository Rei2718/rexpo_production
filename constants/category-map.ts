...
export const CATEGORIES: Category[] = [
    {
        id: 'academic',
        label: 'アカデミック',
        icon: require('@/assets/category/category_01.png'),
        tags: [
    ...
    },
    {
        id: 'entertainment',
        label: 'エンターテイメント',
        icon: require('@/assets/category/category_02.png'),
        tags: [
    ...
    },
    {
        id: 'booth_collab',
        label: 'ブース＆コラボ',
        icon: require('@/assets/category/category_03.png'),
        tags: [
    ...
    },
    {
        id: 'creative',
        label: 'クリエイティブ',
        icon: require('@/assets/category/category_04.png'),
        tags: [
