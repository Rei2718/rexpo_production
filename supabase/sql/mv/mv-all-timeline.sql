-- mv_all_timeline
DROP MATERIALIZED VIEW IF EXISTS public.mv_all_timeline CASCADE;
...
-- indexes
CREATE UNIQUE INDEX idx_mv_all_timeline_starts ON public.mv_all_timeline(starts);

-- security
REVOKE ALL ON public.mv_all_timeline FROM public, anon, authenticated;