export const keys = {
    ...
    get_venue_static_info: (venue_public_id: string) => ['get_venue_static_info', venue_public_id] as const,
    get_venue_dynamic_status: (venue_public_id: string) => ['get_venue_dynamic_status', venue_public_id] as const,
    ...
    get_event_rankings: () => ['get_event_rankings'] as const,
} as const;